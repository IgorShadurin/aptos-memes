 ...
 * Contains copyright, credits and source code link
 */
  ...
  return (
    <footer className="w-full py-4 px-6 mt-auto text-center text-gray-600 dark:text-gray-400 border-t border-gray-300/50">
      <div className="flex flex-col items-center gap-1">
        ...
        <a
          href="https://github.com/IgorShadurin/crypto-memes"
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center gap-1 text-gray-700 dark:text-gray-300 hover:text-pink-600 dark:hover:text-pink-400 transition-colors mt-2"
        >
          <svg
